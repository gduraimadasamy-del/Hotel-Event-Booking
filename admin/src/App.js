...
import { eventsInputs, hotelInputs,  userInputs } from "./formSource";
import "./style/dark.scss";
import { children, useContext } from "react";
import { DarkModeContext } from "./context/darkModeContext";
import { AuthContext } from "./context/AuthContext ";
import { eventsColumns, hotelsColumns, userColumns } from "./datatablesource";
import NewHotel from "./pages/newhotels/NewHotel";
import NewEvents from "./pages/newevent/NewEvent";
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="login" element={<Login />} />
            ...
            <Route path="events">
              <Route index element={<ProtectedRoute><List columns={eventsColumns} /></ProtectedRoute>} />
              <Route path=":eventId" element={<ProtectedRoute><Single /></ProtectedRoute>} />
              <Route
                path="new"
                element={<ProtectedRoute><NewEvents/></ProtectedRoute> }
              />
          </Route>
          </Route>
        </Routes>
